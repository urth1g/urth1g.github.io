    ...
    <ImagesContainer>
      <div className="row">
        <div className="col-sm-4">
          <FlipcardDiv
            front={<img width="100%" src={Html} alt="html" />}
            back={
              <div
                style={{ position: 'relative', height: '198px', left: '-38px' }}
              >
